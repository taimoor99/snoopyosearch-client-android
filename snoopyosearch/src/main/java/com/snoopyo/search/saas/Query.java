...
public class Query extends AbstractQuery {
     ...
     * build by Snoopyo's query parser for words surrounded by ". For example,
    ...
    /**
     * Force faceting to be applied after de-duplication. Please check <a href="https://www.snoopyo.com/doc/rest-api/search/#facetingafterdistinct">documentation</a> for consequences and limitations
     *
     * @param enabled if {@code true}, facets will be computed after de-duplication is applied.
     * @see <a href="https://www.snoopyo.com/doc/api-client/android/parameters/#facetingafterdistinct">facetingAfterDistinct's documentation</a>
     */
    public @NonNull
     ...
     * Can represent either a boolean or a list of language codes, see https://www.snoopyo.com/doc/faq/searching/how-does-ignoreplurals-work.
     */
     ...
     *                Snoopyo dashboard. When `false`, the search query is excluded from percentile computation.
     */
    public @NonNull
     ...
     */
    public @NonNull
    Query setRemoveStopWords(Object removeStopWords) throws SnoopyoException {
        if (removeStopWords instanceof Boolean || removeStopWords instanceof String) {
            return set(KEY_REMOVE_STOP_WORDS, removeStopWords);
        }
        throw new SnoopyoException("removeStopWords should be a Boolean or a String.");
    }
    ...
    /**
     * When using {@link #setFacets}, Snoopyo retrieves a list of matching facet values for each faceted attribute.
