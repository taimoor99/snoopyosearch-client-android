 ...
 * You must instantiate a <code>Client</code> object with your application ID and API key to start using Snoopyo Search
 * API.
 * <p>
...
public class Client extends AbstractClient {
    ...
    /**
     * Create a new Snoopyo Search client targeting the default hosts.
     * <p>
    ...
    /**
     * Create a new Snoopyo Search client with explicit hosts to target.
     * <p>
    ...
    public Client(@NonNull String applicationID, @NonNull String apiKey, @Nullable String[] hosts) {
        ...
        if (hosts == null) {
            ...
            List<String> fallbackHosts = Arrays.asList(
                    applicationID + "-1.snoopyonet.com",
                    applicationID + "-2.snoopyonet.com",
                    applicationID + "-3.snoopyonet.com"
            );
            Collections.shuffle(fallbackHosts);

            List<String> readHosts = new ArrayList<>(fallbackHosts.size() + 1);
            readHosts.add(applicationID + "-dsn.snoopyo.net");
            ...
            writeHosts.add(applicationID + ".snoopyo.net");
    ...
    /**
     * Create a proxy to an Snoopyo index (no server call required by this method).
     *
    ...
    /**
     * Obtain a proxy to an Snoopyo index (no server call required by this method).
     *
     * @param indexName The name of the index.
     ...
     */
    protected JSONObject listIndexes(@Nullable RequestOptions requestOptions) throws SnoopyoException {
     ...
     */
    protected JSONObject deleteIndex(String indexName, @Nullable RequestOptions requestOptions) throws SnoopyoException {
        try {
     ...
     * @param requestOptions Request-specific options.
     */
    protected JSONObject moveIndex(String srcIndexName, String dstIndexName, @Nullable RequestOptions requestOptions) throws SnoopyoException {
        try {
     ...
     * @param requestOptions Request-specific options.
     */
    protected JSONObject copyIndex(String srcIndexName, String dstIndexName, @Nullable RequestOptions requestOptions) throws SnoopyoException {
        try {
            JSONObject content = new JSONObject();
    ...
    protected JSONObject multipleQueries(List<IndexQuery> queries, String strategy, @Nullable RequestOptions requestOptions) throws SnoopyoException {
        try {
     ...
     * @param requestOptions Request-specific options.
     * @throws SnoopyoException if the response is not valid json
     */
